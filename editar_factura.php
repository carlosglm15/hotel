<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$active_editar_factura="active";	
	$title="Nuevo Registro|Sistema Hotel";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nit_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura";
		...
		if ($count==1)
		{
				...
				$nit_cliente=$rw_factura['nit_cliente'];
...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		<?php 
			include("modal/buscar_habitacion.php");
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
				...
				<div class="form-group row">
				  <label for="nit_cliente" class="col-md-1 control-label">Nit</label>
				  <div class="col-md-3">
					  <input type="text" class="form-control input-sm" id="nit_cliente" placeholder="Selecciona un cliente" required value="<?php echo $nit_cliente;?>">
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoHabitacion">
						 <span class="glyphicon glyphicon-plus"></span> Nueva Habitacion
						</button>
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoCliente">
						 <span class="glyphicon glyphicon-user"></span> Nuevo cliente
						</button>
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">
						 <span class="glyphicon glyphicon-search"></span> Agregar habitaciones
						</button>
	...
	$("#nit_cliente" ).on( "keydown", function( event ) {

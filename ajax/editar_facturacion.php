...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_factura (numero_factura, id_habitacion,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");
...
<?php
	$sumador_total=0;
	$sql=mysqli_query($con, "select * from habitaciones, facturas, detalle_factura where facturas.numero_factura=detalle_factura.numero_factura and  facturas.id_factura='$id_factura' and habitaciones.id_habitacion=detalle_factura.id_habitacion");
	...
	$sumador_total+=$precio_total_r;//Sumador
		...
		?>
		<tr>
			<td class='text-center'><?php echo $codigo_habitacion;?></td>

...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from habitaciones, detalle_factura, facturas where habitaciones.id_habitacion=detalle_factura.id_habitacion and detalle_factura.numero_factura=facturas.numero_factura and facturas.id_factura='".$id_factura."'");

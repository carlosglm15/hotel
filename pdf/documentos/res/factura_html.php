...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from habitaciones, tmp where habitacion.id_habitacion=tmp.id_habitacion and tmp.session_id='".$session_id."'");
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            ...
            <td class='<?php echo $clase;?>' style="width: 60%; text-align: left"><?php echo $nombre_habitacion;?></td>
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura VALUES ('','$numero_factura','$id_habitacion','$cantidad','$precio_venta_r')");

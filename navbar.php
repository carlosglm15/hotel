...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Sistema de Control de Ingresos</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="<?php echo $active_principal;?>"><a href="principal.php"><i class='glyphicon glyphicon-list-alt'></i> Reservaciones <span class="sr-only">(current)</span></a></li>
		<li class="<?php echo $active_habitacion;?>"><a href="habitacion.php"><i class='glyphicon glyphicon-user'></i> Habitaciones</a></li>
